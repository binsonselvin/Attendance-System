...
public class HomePageLoginIT
{
    ...
    public HomePageLoginIT() {
        ...
        (this.backBtn = new JButton("BACK")).setFont(new Font("Consolas", 1, 15));
        ...
        this.loginBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                final String username = HomePageLoginIT.this.userTf.getText();
                final String password = HomePageLoginIT.this.passTf.getText();
                if (!username.equals("Gayathri") || password.equals("123456")) {}
                f.dispose();
                final TeacherFrameIT teacherFrameIT = new TeacherFrameIT(username);
                if (password.equals("") || username.equals("")) {
                    HomePageLoginIT.this.dateLabel.setForeground(Color.red);
                    HomePageLoginIT.this.dateLabel.setText("USERNAME or PASSWORD cannot be empty");
                }
            }
        });
        ...
        (this.dateLabel = new JLabel("", 4)).setText("TODAYS DATE: " + dateReturn() + " (*IT DEPARTMENT*)");
