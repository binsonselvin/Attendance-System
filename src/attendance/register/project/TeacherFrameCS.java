    ...
    public void setDateTime() {
        new Timer(0, new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent ae) {
                TeacherFrameCS.this.showDateTime();
            }
        }).start();
    }
    
    public TeacherFrameCS(final String name) {
        this.name = name;
        ...
        final String[] classArrayCS = { "FYCS", "SYCS", "TYCS" };
        final String[] cs_sem1 = { "COD", "Prog with Python-I", "FOSS", "Database sys.", "D.Maths", "D.Stats", "Soft Skills" };
        final String[] cs_sem2 = { "Prog with C", "Prog with Pyhton-II", "Linux", "Data Structure", "Calculus", "Stats methods and Hypo testing", "Green Technologies" };
        final String[] cs_sem3 = { "TOC", "Core Java", "OS", "DBMS", "CGT", "IOT", "WP" };
        final String[] cs_sem4 = { "FOA", "Adv.Java", "CN", "SE", "LA using Python", ".NET", "Android Devp." };
        final String[] cs_sem5 = { "AI", "ST & QA", "INS", "WS", "GP" };
        final String[] cs_sem6 = { "Cloud Computing", "Cyber Forensics", "Info retrieval", "Data Science", "Ethical Hacking" };
